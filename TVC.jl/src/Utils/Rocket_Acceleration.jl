...
export Thrust, Mass, CG, Acceleration, ThrottleLevel

ThrustTable = XLSX.readdata("$(@__DIR__)/F15_Thrust.xlsx", "Sheet1!A1:B27"); # $(@__DIR__) gives directory of Rocket_Acceleration.jl
MassTable = XLSX.readdata("$(@__DIR__)//mass,cg,I.xlsx", "mass,cg,I!A2:B3608");
CGTable = [XLSX.readdata("$(@__DIR__)/mass,cg,I.xlsx", "mass,cg,I!A2:A3608") XLSX.readdata("$(@__DIR__)/mass,cg,I.xlsx", "mass,cg,I!E2:E3608")]
